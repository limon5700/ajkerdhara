...
async function clearCacheAndCheck() {
  ...
  try {
    console.log('🔍 Clearing Cache and Checking Database...');
    console.log('==========================================');
    ...
    const articles = await articlesCollection.find({}).sort({ publishedDate: -1 }).toArray();
    
    console.log('\n📋 Articles in Database (sorted by date):');
    console.log('==========================================');
    ...
    console.log('\n🔄 Cache will be cleared when you restart the development server');
    console.log('💡 Run: npm run dev (or restart your current dev server)');
