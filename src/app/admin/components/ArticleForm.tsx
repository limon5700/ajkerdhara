          ...
          render={({ field }: { field: any }) => (
            <FormItem className="relative">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Button type="button" variant="secondary" size="sm" onClick={handleInsertAdInline}>
                  Insert Ad (Label)
                </Button>
              </div>
              ...
              <FormControl>
                <div className="relative">
                  <Textarea {...field} ref={contentRef} rows={16} placeholder="Write the article content here..." />
                  <Button type="button" variant="secondary" size="icon" onClick={handleInsertAdInline} className="absolute top-2 right-2 z-10">
                    +
                  </Button>
                </div>
              </FormControl>
